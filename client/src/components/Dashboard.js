...
function Dashboard() {
  ...
  const getdata = async (e) => {
    ...
    const res=await fetch("https://firstproject-main.onrender.com/getdata",{
        method:"GET",
        headers:{
...
useEffect(()=>{
  ...
  const navigate=useNavigate();
   ...
   const DashboardValid= async()=>{
    ...
    const res = await fetch("https://firstproject-main.onrender.com/validuser", {
      method: "GET",
      headers: {
          "Content-Type": "application/json",
          "Authorization": token
  ...
  useEffect(() => {
    ...
    const deleteuser=async(id)=>{
        const res2=await fetch(`https://firstproject-main.onrender.com/deleteuser/${id}`,{
          method: "DELETE",
          headers: {
              "Content-Type": "application/json",
